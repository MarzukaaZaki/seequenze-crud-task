...
const DetailsModal = ({ isVisible, onClose, dataImg }) => {
    const { _id, author_name, width, height, url, download_url } = dataImg;
        ...
        <div className='fixed inset-0 bg-black bg-opacity-20 backdrop-blur-sm flex justify-center items-center'>
            <div className='w-full md:w-1/2 flex flex-col'>
                ...
                <div className='bg-white  md:flex flex-col items-center justify-center gap-2 rounded p-2'>
                    ...
                    <div>
                        <p className='text-primary border-t-2 border-b-2 font-bold text-xs mb-3 px-2 py-1 rounded-xl '>Id# {_id}</p>
                        <p className='text-xl font-bold'>Image By: {author_name}</p>
